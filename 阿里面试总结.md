...
![MVVM的结构图](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-1498627712415999.png)
...
##6: Git版本控制
![git](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-166109-e49ba9e2ca4e3dfd.gif)
...
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046035126209.jpg)

这是AFNetworking发起一个Get请求的流程图，大概可以分为这几个步骤，我会逐个解读这个流程。

AFHTTPSessionManager发起Get请求

![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046035725703.jpg)
...
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046036181235.jpg)
...
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046036491140.jpg)
...
```
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046037085327.jpg)


先设置HTTP header，之后格式化请求参数，设置参数的编码类型。这个是这个方法的基本操作流程。对于Get操作来说，参数是直接拼接在请求地址后面。
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046037422742.jpg)
...
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046038102049.jpg)

NSURLSessionDelegate方法
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046038403507.jpg)

NSURLSessionTaskDelegate方法

AFN里面有关NSURLSessionDelegate的回调方法非常的多，这里我们只调和NSURLSessionTask相关的部分方法和KVO处理来进行说明，其他的大家可以参考源码细看。

![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046038682946.jpg)

KVO监听请求过程
![KVO监听请求过程](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046039410560.jpg)



收到响应数据
![](http://ovsiiuil2.bkt.clouddn.com/2017-09-05-15046039806193.jpg)
