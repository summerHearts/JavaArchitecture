...
![](https://www.icheesedu.com/images/qiniu/c9ad2bf4-5580-4018-bce4-1b9a71804d9c.png)

![](https://www.icheesedu.com/images/qiniu/Xnip2018-08-16_14-52-36.png)
...
每个 Java 方法在执行的同时会创建一个栈帧用于存储局部变量表、操作数栈、常量池引用、动态链接等信息，从调用直至执行完成的过程，就对应着一个栈帧在 Java 虚拟机栈中入栈和出栈的过程。

![](https://www.icheesedu.com/images/qiniu/926c7438-c5e1-4b94-840a-dcb24ff1dafe.png)
...
![](https://www.icheesedu.com/images/qiniu/JNI-Java-Native-Interface.jpg)
...
用于存放已被加载的类信息、常量、静态变量、JIT即时编译器编译后的代码等数据。
...
##JMM
![](https://www.icheesedu.com/images/qiniu/Xnip2018-08-16_15-36-32.png)

Meta Space 设计是为了规避永久代内存溢出的问题。类似ArrayList,可以动态扩容。同时需要管制，不能无限制大小。
2、8 原则。分代的原因是：生命周期不一样。新生代划分的原因是：80%的对象朝生夕死。
...
![](https://www.icheesedu.com/images/qiniu/0635cbe8.png)
...
![](https://www.icheesedu.com/images/qiniu/a4248c4b-6c1d-4fb8-a557-86da92d3a294.jpg)
...
![](https://www.icheesedu.com/images/qiniu/902b83ab-8054-4bd2-898f-9a4a0fe52830.jpg)

让所有存活的对象都向一端移动，然后直接清理掉端边界以外的内存。

### 3. 复制

![](https://www.icheesedu.com/images/qiniu/e6b733ad-606d-4028-b3e8-83c3a73a3797.jpg)
...
![](https://www.icheesedu.com/images/qiniu/c625baa0-dde6-449e-93df-c3a67f2f430f.jpg)
...
![](https://www.icheesedu.com/images/qiniu/22fda4ae-4dd5-489d-ab10-9ebfdad22ae0.jpg)
...
![](https://www.icheesedu.com/images/qiniu/232323ttvv.jpg)
...
![](https://www.icheesedu.com/images/qiniu/08f32fd3-f736-4a67-81ca-295b2a7972f2.jpg)
...
![](https://www.icheesedu.com/images/qiniu/278fe431-af88-4a95-a895-9c3b80117de3.jpg)
...
![](https://www.icheesedu.com/images/qiniu/62e77997-6957-4b68-8d12-bfd609bb2c68.jpg)
...
![](https://www.icheesedu.com/images/qiniu/4cf711a8-7ab2-4152-b85c-d5c226733807.png)

G1 把堆划分成多个大小相等的独立区域（Region），新生代和老年代不再物理隔离。

![](https://www.icheesedu.com/images/qiniu/9bbddeeb-e939-41f0-8e8e-2b1a0aa7e0a7.png)

通过引入 Region 的概念，从而将原来的一整块内存空间划分成多个的小空间，使得每个小空间可以单独进行垃圾回收。这种划分方法带来了很大的灵活性，使得可预测的停顿时间模型成为可能。通过记录每个 Region 垃圾回收时间以及回收所获得的空间（这两个值是通过过去回收的经验获得），并维护一个优先列表，每次根据允许的收集时间，优先回收价值最大的 Region。

每个 Region 都有一个 Remembered Set，用来记录该 Region 对象的引用对象所在的 Region。通过使用 Remembered Set，在做可达性分析的时候就可以避免全堆扫描。

![](https://www.icheesedu.com/images/qiniu/f99ee771-c56f-47fb-9148-c0036695b5fe.jpg)
...
![](https://www.icheesedu.com/images/qiniu/32b8374a-e822-4720-af0b-c0f485095ea2.jpg)
...
![](https://www.icheesedu.com/images/qiniu/class_loader_hierarchy.png)
